    ...
    async def get_column_statistics(
        ...
        try:
            ...
            return ColumnStats(
                ...
                percentile_25=safe_value(row[7]),
                median_value=safe_value(row[8]),
                percentile_75=safe_value(row[9]),
                percentile_95=safe_value(row[10]),
                percentile_99=safe_value(row[11]),
